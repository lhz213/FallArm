				...
				<ul class="nav navbar-nav navbar-right">
					...
					<c:if test="${patient!=null}">
						<li>
							<p class="navbar-text">
								Hello,
								<c:if test="${patient.gender == 1 }">Mr. </c:if>
								<c:if test="${patinet.gender == 0 }">Mrs. </c:if>
								${patinet.lastName}
							</p>
						</li>
						<li><a
							href="/FallArm/PersonServlet?role=patient&operation=search&id=${patient.id}">Profile</a></li>
		...
		<div class="row">
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				...
				<div class="row placeholders">
					...
					<div class="col-xs-6 col-sm-3 placeholder">
						<p class="img-responsive">
							<span class="badge badge-info">${totalNumberOfContact}</span>
						</p>
						<h4>Related</h4>
